# @Time  : 2024/5/20 10:42
# @Filename : AlgSimplify.py
...
try:
    ...
    class GDALSimplifier(object):
        ...
        def __init__(*args, **kwargs):
            print("""django.contrib.gis.gdal not found.
...
if __name__ == "__main__":
    ...
    print
    "%s vertices removed in %02f seconds" % (n - len(pts), end - start)
